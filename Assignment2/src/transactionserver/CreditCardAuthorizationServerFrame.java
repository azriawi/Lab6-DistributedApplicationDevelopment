...
public class CreditCardAuthorizationServerFrame extends JFrame {
	 ...
	 */
	public CreditCardAuthorizationServerFrame() {
		setBackground(Color.BLACK);
		
		// Default frame setting
		getContentPane().setLayout(new BorderLayout());
		this.setTitle("TCP Application: Server Side");
		this.setSize(new Dimension(557, 419));  
		...
		lblServerStatus.setForeground(Color.ORANGE);
		// Row, Column
		this.txtRequestStatus  = new JTextArea(20, 60);
		txtRequestStatus.setBackground(Color.BLACK);
		txtRequestStatus.setForeground(Color.ORANGE);
	...
	private JPanel getServerStatusPanel(Font font) {
		...
		JLabel lblServer = new JLabel ("Credit Card Authorization Server");
		lblServer.setForeground(Color.ORANGE);
		
		// Style the components
		lblServer.setFont(new Font("SansSerif", Font.PLAIN, 20));
		lblServerStatus.setFont(font);
		lblServer.setBackground(Color.BLACK);
		lblServer.setOpaque(true);
		lblServerStatus.setBackground(Color.BLACK);
